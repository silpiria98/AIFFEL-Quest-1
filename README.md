...
먼저, **저커버그**가가 자신의 Facebook 프로필([https://www.facebook.com/zuck](https://www.facebook.com/zuck))에 업로드한 동영상으로 자비스를 만나 볼까요?
...
###### 최창현 기자  | 입력 2023.03.19 21:16 | 댓글 0
...
git과 github를 항상 쓰면서도 원격에서 먼저 만드느냐, 로컬에서 먼저 만드느나, 다른 사람의 레포지토리를 가져오느냐 등의 상황에 따라 헷갈렸는데 이번 기회에 정리할 수 있어서 좋았다. 한가지 더 알아보고 싶은 점은 평소 code로 vscode를 열어 code editor를 사용했는데 cloud shell에서는 code 명령어를 사용할 수가 없어 vim을 써야한다는 점이 불편하다.
